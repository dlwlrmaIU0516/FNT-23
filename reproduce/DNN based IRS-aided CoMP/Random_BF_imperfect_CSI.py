...
from alternaing_optimization_random_BF import AO_cvx
import os
import warnings
...
save_mat_template_avg_min_rate = './fig/Tx_P[dB]_{}_M_{}_imperfect_gamma_{}/RandomBF_avg_min_rate.mat'
save_fig_template_avg_min_rate = './fig/Tx_P[dB]_{}_M_{}_imperfect_gamma_{}/RandomBF_avg_min_rate.png'
