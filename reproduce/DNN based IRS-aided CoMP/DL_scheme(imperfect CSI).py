...
save_mat_template_avg_min_rate = './fig/Tx_P[dB]_{}_M_{}_imperfect/DL_avg_min_rate.mat'
save_fig_template_avg_min_rate = './fig/Tx_P[dB]_{}_M_{}_imperfect/DL_avg_min_rate.png'
